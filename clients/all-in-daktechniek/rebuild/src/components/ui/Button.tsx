...
export type ButtonVariant = "primary" | "secondary" | "outline" | "ghost" | "onInk";
...
const variants: Record<ButtonVariant, string> = {
  // Green primary with dark ink text (green is mid-tone → ink text is ~5.2:1, accessible)
  primary: "bg-green text-ink hover:bg-green/90 focus-visible:ring-offset-surface",
  secondary: "bg-ink text-text-invert hover:bg-ink-800 focus-visible:ring-offset-surface",
  outline:
    "border border-ink/25 bg-surface text-text-strong hover:bg-surface-muted focus-visible:ring-offset-surface",
  ghost: "text-green-strong hover:bg-green-soft focus-visible:ring-offset-surface",
  // For use on the dark ink background
  onInk: "border border-line-invert bg-ink-800 text-text-invert hover:bg-ink-700 focus-visible:ring-offset-ink",
};
