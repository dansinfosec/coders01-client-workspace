  ...
  return (
    <div className="lg:hidden">
      ...
      >
        ...
        <nav aria-label="Mobiele navigatie" className="flex-1 overflow-y-auto overscroll-contain px-3 py-4">
              ...
              return (
                <li key={item.label}>
                  ...
                  >
                    {item.label}
                    <ChevronDown
                      className={cn("h-5 w-5 shrink-0 text-text-muted transition-transform", sectionOpen && "rotate-180")}
                      aria-hidden
                    />
                  </button>
                  {sectionOpen && (
        ...
        {/* CTA-zone: primair naar eigen tooling, bellen/WhatsApp klein secundair. */}
