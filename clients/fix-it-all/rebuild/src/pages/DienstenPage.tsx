...
export function DienstenPage() {
  return (
    <>
      <SEO
        title="Diensten — APK, onderhoud, reparatie & meer in Utrecht"
        description="Bekijk alle diensten van Fix-it All in Utrecht: APK-keuring, onderhoud, kleine en grote beurt, uitlaat- en laswerk, airco, banden, reparatie en diagnose."
        path="/diensten"
