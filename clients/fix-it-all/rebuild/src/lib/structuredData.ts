...
/**
 * Herbruikbare JSON-LD-bouwers. Alleen geverifieerde feiten; onbekende velden (geo, priceRange,
 * KVK) worden bewust weggelaten in plaats van verzonnen.
 *
 * NB: absolute URL's gebruiken een placeholder-basis tot het live domein bevestigd is.
 */
const SITE = "https://www.fix-itall.nl"; // TODO: bevestigen live domein
