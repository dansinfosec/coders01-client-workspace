...
export function ContactPage() {
  ...
  return (
    <>
      <SEO
        title="Contact — Fix-it All Utrecht"
        description="Bel, mail, WhatsApp of kom langs bij Autobedrijf Fix-it All aan de Eendrachtlaan 242 in Utrecht. Bekijk onze openingstijden en stuur ons een bericht."
        path="/contact"
        jsonLd={[
          localBusinessSchema(),
          breadcrumbSchema([
