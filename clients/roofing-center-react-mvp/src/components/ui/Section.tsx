...
type Tone = "default" | "muted" | "navy" | "cream";
...
const tones: Record<Tone, string> = {
  ...
  navy: "bg-navy text-text-invert",
  cream: "bg-cream-soft text-text-body",
};

const spacings = { md: "py-12 sm:py-16", lg: "py-16 sm:py-24" };

export function Section({ children, tone = "default", spacing = "lg", width = "default", id, ariaLabel, className }: SectionProps) {
  return (
