 ...
 * en de navigatie. Merk-neutrale, algemeen-ware placeholder-content; pas per klant aan.
 *
 * REGELS:
...
export const services: Service[] = [
  {
    ...
    showApkOffer: true,
    seo: {
      title: "APK-keuring — RDW-erkend",
      description:
        "RDW-erkende APK-keuring. Ervaren keurmeesters, duidelijk rapport en eerlijk advies. Gratis APK bij een grote onderhoudsbeurt. Maak een afspraak.",
    },
  },
  {
    slug: "onderhoud",
    ...
    faq: [
      ...
      },
      {
        ...
        a: "Ja. Wij onderhouden en repareren alle merken.",
      },
    ],
    related: ["kleine-beurt", "grote-beurt", "apk-keuring"],
    showApkOffer: true,
    seo: {
      title: "Auto-onderhoud — kleine & grote beurt",
      description:
        "Auto-onderhoud voor alle merken. Kleine en grote onderhoudsbeurt door gediplomeerde monteurs. Gratis APK bij een grote beurt. Maak een afspraak.",
    },
  },
  {
    slug: "kleine-beurt",
    ...
    seo: {
      title: "Kleine onderhoudsbeurt",
      description:
        "Kleine onderhoudsbeurt: olie en oliefilter verversen plus controle van 20+ vitale onderdelen. Gediplomeerde monteurs. Maak een afspraak.",
    },
  },
  {
    slug: "grote-beurt",
    ...
    showApkOffer: true,
    seo: {
      title: "Grote onderhoudsbeurt — gratis APK",
      description:
        "Grote onderhoudsbeurt: bougies, filters, olie en 80+ controlepunten. Gratis APK bij een grote beurt. Gediplomeerde monteurs. Maak een afspraak.",
    },
  },
  {
    slug: "uitlaat-laswerk",
    title: "Uitlaat & laswerk",
    ...
    seo: {
      title: "Uitlaat lassen — laswerk aan uw uitlaat",
      description:
        "Uitlaat lassen bij lekkage, roest of stootschade. Vakkundig laswerk in eigen werkplaats, leenfiets beschikbaar. Neem contact op.",
    },
  },
  {
    slug: "airco-service",
    ...
    seo: {
      title: "Aircoservice — airco reinigen & bijvullen",
      description:
        "Aircoservice: reinigen, controleren en bijvullen (R134a). Koele lucht zonder nare geurtjes. Advies elke 12 maanden. Maak een afspraak.",
    },
  },
  {
    slug: "bandenservice",
    ...
    intro:
      "Banden leggen het contact met het wegdek: goede grip en een perfecte wegligging zijn van groot belang voor uw veiligheid. Ons bandenassortiment bestaat uit een gevarieerd aanbod van topmerken, waarbij kwaliteit en veiligheid vooropstaan.",
    includes: [
      "Banden (de)monteren",
      "Balanceren",
      "Bandenreparatie",
    ...
    seo: {
      title: "Bandenservice — monteren, balanceren & opslag",
      description:
        "Bandenservice: (de)monteren, balanceren, reparatie, opslag en velgen spuiten. Gratis bandenadvies en topmerken. Maak een afspraak.",
    },
  },
  {
    slug: "reparatie",
    ...
    faq: [
      {
        ...
        a: "Ja, wij werken aan alle merken.",
      },
      {
    ...
    seo: {
      title: "Autoreparatie — alle merken",
      description:
        "Autoreparatie voor alle merken. Gediplomeerde monteurs, eerlijk advies en kosten vooraf in overleg. Neem contact op of maak een afspraak.",
    },
  },
  {
    slug: "diagnose",
    ...
    seo: {
      title: "Autodiagnose — storing & waarschuwingslampje",
      description:
        "Autodiagnose: waarschuwingslampje of storing laten uitlezen met moderne apparatuur. Gericht advies over de vervolgstappen. Maak een afspraak.",
    },
  },
];
