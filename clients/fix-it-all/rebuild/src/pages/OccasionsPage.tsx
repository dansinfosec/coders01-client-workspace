...
export function OccasionsPage() {
  ...
  return (
    <>
      <SEO
        title="Occasions in Utrecht — betrouwbare tweedehands auto's"
        description="Bekijk de occasions van Fix-it All in Utrecht. Geselecteerd en onderhouden door onze eigen werkplaats, met duidelijke specificaties en eerlijke omschrijving."
        path="/occasions"
        jsonLd={[
          breadcrumbSchema([
            { name: "Home", path: "/" },
