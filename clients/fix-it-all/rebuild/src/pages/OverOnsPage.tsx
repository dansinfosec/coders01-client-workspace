...
const values = [
  ...
  { icon: Users, title: "Onafhankelijk sinds 2000", text: "Een vertrouwd adres in Utrecht met jarenlange ervaring en vaste klanten." },
];

const facts = [
  { value: `Sinds ${company.foundedYear}`, label: "Onafhankelijke vakgarage" },
...
export function OverOnsPage() {
  return (
    <>
      <SEO
        title="Over Fix-it All — uw vakgarage in Utrecht sinds 2000"
        description="Autobedrijf Fix-it All is sinds 2000 een onafhankelijke vakgarage in Utrecht. Persoonlijke aandacht en eerlijk advies voor alle merken: APK, onderhoud, uitlaatwerk, airco, banden en occasions."
        path="/over-ons"
        jsonLd={[
          localBusinessSchema(),
          breadcrumbSchema([
      ...
      <PageHero
        eyebrow="Over ons"
        title="Uw vakgarage in Utrecht sinds 2000"
          ...
          <div className="grid gap-10 lg:grid-cols-[1.2fr_0.8fr] lg:gap-16">
            <div className="max-w-prose">
              ...
              <div className="mt-6 space-y-4 leading-relaxed text-text-body">
                <p>
                  Autobedrijf Fix-it All is sinds {company.foundedYear} een onafhankelijke vakgarage in Utrecht.
                  Wij zijn uw pitstop voor autokeuring, onderhoud en occasions — voor alle merken, onder één dak.
                </p>
                <p>
        ...
        <Container>
          <div className="flex flex-col items-start justify-between gap-8 lg:flex-row lg:items-center">
            <div>
              ...
              <h2 className="mt-2 font-display text-2xl font-bold text-paper sm:text-3xl">Bezoek onze werkplaats in Utrecht</h2>
